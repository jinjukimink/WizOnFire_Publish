...
const TeamMatch = () => {
    ...
    const getLogoImg = (teamName: string | undefined): string => {
        return teamName ? logo.get(teamName) || ktwiz : ktwiz;
    }

    const navigate = useNavigate();
    const { data : game, isLoading, error } = useFetchData<GameResponse>("/game/recentGames");
    ...
    <TeamMatchContainer>
        ...
        {show && (
            <>
                ...
                <ScoreContainer>
                    <ScoreBox
                        imageSrc={getLogoImg(show.homeKey)}
                    ...
                    <ScoreBox
                        ...
                        scoreLeft="87%"
                        transform="50%"
                        imageSrc={getLogoImg(show.visitKey)}
